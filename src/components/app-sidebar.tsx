...
import { Activity, BookOpen, Folder, LayoutGrid, UserRoundCog, UserRoundPlus, UsersRound } from 'lucide-react';
...
export function AppSidebar({ user }: { user: User }) {
    ...
    const adminNavItems: NavItem[] = [
        ...
        { title: t('Bids'), href: '/dashboard/admins/bids', icon: Activity },
    ];
    const footerNavItems: NavItem[] = [
        { title: t('Repository'), href: 'https://github.com/HumbertoFox/', icon: Folder, },
