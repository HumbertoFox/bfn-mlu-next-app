      ...
      <header className="w-full not-has-[nav]:hidden lg:max-w-[1440px] flex justify-between">
        ...
        <nav className="flex items-center justify-end gap-4">
          {session ? (
            <Link
              href="dashboard"
              className="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-xs lg:text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]"
            >
              {t('Dashboard')}
            </Link>
          ) : (
            <>
              <Link
                href="/login"
                className="inline-block rounded-sm border border-transparent px-5 py-1.5 text-xs lg:text-sm leading-normal text-[#1b1b18] hover:border-[#19140035] dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A]"
              >
                {t('Login')}
              </Link>
              <Link
